    ...
    return (
        <>
            ...
            <p className="font-normal mt-1 text-center text-gray-500 text-sm sm:text-lg mx-7">
                Don't get caught in a phishing trap. Happens 2.6 million times a
                year, but with our app, you can protect yourself.
            </p>
            ...
            <div className="flex max-md:flex-col md:flex-row mt-5">
                <input
                    type="text"
                    placeholder="Enter website address or URL (eg- www.Tesla.com)"
