...
export function Result(props) {
    ...
    function OutputStatement(props) {
            ...
            return (
                <>
                    <h1 className="font-light text-center mt-3 max-sm:text-lg sm:text-2xl md:text-3xl ">
                        The given URL is{' '}
                        <span className="font-extrabold"> SAFE </span> ! ✅ No
            ...
            return (
                <>
                    <h1 className="font-light text-center mt-3 max-sm:text-lg sm:text-2xl md:text-3xl ">
                        ...
                        ! ⚠️ Use Incognito Mode & VPN for safety.
                    </h1>
                </>
            );
        }
        ...
        return (
            <>
                <h1 className="font-light text-center mt-3 max-sm:text-lg sm:text-2xl md:text-3xl ">
                    The given URL is{' '}
                    <span className="font-extrabold"> Highly Malicious </span> !
                    ❌ Please Don't Visit It.
                </h1>
            </>
        );
    }
            ...
            return (
                <>
                    <img
                        src={SafeGif}
                        alt="URL Safe Gif"
                        className="ml-[23%] w-[55%] sm:ml-[31%] sm:w-[38%] lg:ml-[37%] lg:w-[26%] mt-2"
                    />
                </>
            );
        }
        ...
        return (
            <>
                <img
                    src={WarningGif}
                    alt="Warn Gif"
                    className="ml-[23%] w-[55%] sm:ml-[33%] sm:w-[38%] lg:ml-[37%] lg:w-[26%] mt-2"
                />
            </>
        );
    }
    ...
    return (
        <>
            ...
            <h1 className="font-semibold text-center max-sm:text-xl sm:text-2xl">
                "{input_url}"
            </h1>
            ...
            <div className="flex justify-center">
                <div className="grid grid-cols-2 gap-y-4 gap-x-8 max-w-2xl mt-8">
                    ...
                    <div className="text-center bg-gray-200 p-2 rounded">
                        Domain is Older Than 3 Months:{' '}
                        {output.isOlderThan3Months ? '✅ Yes' : '❌ No'}
                    </div>
                    <div className="text-center bg-gray-200 p-2 rounded">
                        Uses Temporary Domain Registration (Vercel, Heroku etc):{' '}
                        {output.isTemporaryDomain ? '❌ Yes' : '✅ No'}
                    </div>
                    <div className="text-center bg-gray-200 p-2 rounded">
                        Passed Google WebSafe Evaluation:{' '}
                        {output.GoogleSafePassed ? '✅ Yes' : '❌ No'}
                    </div>
                    <div className="text-center bg-gray-200 p-2 rounded">
                        Passed Nortan WebSafe Evaluation:{' '}
                        {output.NortanWebSafePassed ? '✅ Yes' : '❌ No'}
                    </div>
                    <div className="text-center bg-gray-200 p-2 rounded">
                        BlackListed in URLVoid sources:{' '}
                        {output.InURLVoidBlackList ? '❌ Yes' : '✅ No'}
                    </div>
                    <div className="text-center bg-gray-200 p-2 rounded">
                        BlackListed in Mcaffe sources:{' '}
                        {output.InMcaffeBlackList ? '❌ Yes' : '✅ No'}
                    </div>
                    <div className="text-center bg-gray-200 p-2 rounded">
                        BlackListed in Sucuri sources:{' '}
                        {output.InSucuriBlacklist ? '❌ Yes' : '✅ No'}
                    </div>
                    <div className="text-center bg-gray-200 p-2 rounded">
                        BlackListed in IpSet sources:{' '}
