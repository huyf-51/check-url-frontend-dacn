...
function TypoSquatGenerator() {
    ...
    const handleClick = async () => {
        if (input_Url.length <= 4) {
            ...
            setSnackbarState(
                'Please provide a valid domain address!',
                'warning',
                true
            );
            return;
        ...
        try {
            ...
            if (output == false) {
                ...
                setSnackbarState(
                    'Provided URL must be valid and active!',
                    'warning',
                    true
                );
                return;
            ...
            <div className="bg-transparent flex flex-col ">
                <div>
                    ...
                    <p className="mt-3 text-base opacity-70 text-center mx-[28%]">
                        Identify potential typesquatting threats and find
                        lookalike domains that adversaries can use to attack
                        you. Discover similar looking registered URLs and take
                        proactive measures to protect your brand and stay one
                        step ahead in the digital landscape.
                    </p>
                </div>
                ...
                {showProgress ? (
                    <div className="mt-8 flex flex-col items-center">
                        <p className="mb-3 font-light">
                            {' '}
                            Scanning, this will takes 1-2 minutes.....
                        </p>
