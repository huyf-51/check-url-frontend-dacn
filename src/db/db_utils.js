...
export async function reportURLtoDatabase(
    url,
    category,
    reportedby,
    urlSource,
...
export const reportBulkURLsToDatabase = async (
    urls,
    category,
    reportedby,
    additional
...
export async function getAllReportedUrls() {
    try {
        const reportedUrls = await getAllDocumentsFromCollection(
            'Reported_Urls'
        );
        const bulkReportedUrls = await getAllDocumentsFromCollection(
            'Bulk_Reported_Urls'
        );
        ...
        allDocuments.sort((a, b) => {
            const reportedOnA = new Date(a.ReportedOn);
            const reportedOnB = new Date(b.ReportedOn);
